...
public class Red_2_NoCycle extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence traj1 = drive.trajectorySequenceBuilder(new Pose2d(-30, -63.0, -1.5707963267948966))
                .lineToLinearHeading(new Pose2d(-54.0, -53.0, -1.5707963267948966))

                .lineToLinearHeading(new Pose2d(-57.0, -68.0, -1.5707963267948966 - Math.toRadians(-55)))
                .build();

        TrajectorySequence traj2 = drive.trajectorySequenceBuilder(new Pose2d(-57.0, -68.0, -1.5707963267948966 - Math.toRadians(-55)))
                .lineToSplineHeading(new Pose2d(-27.9, -29.7, -1.5707963267948966-Math.toRadians(40)))
                .build();

        TrajectorySequence traj22 = drive.trajectorySequenceBuilder(new Pose2d(-27.9, 29.7, 1.5707963267948966+Math.toRadians(40)))
                .lineToLinearHeading(new Pose2d(-25.0, -39.60, -1.5707963267948966-Math.toRadians(46)))
                .build();

        TrajectorySequence traj3 = drive.trajectorySequenceBuilder(new Pose2d(-25.0, 39.60, 1.5707963267948966+Math.toRadians(46)))
