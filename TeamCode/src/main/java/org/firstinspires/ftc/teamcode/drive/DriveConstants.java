...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(11, 0, 5,
            27);
    ...
    public static double GEAR_RATIO = 1.003; // output (wheel) speed / input (motor) speed
    ...
    public static double MAX_ANG_VEL = 4.0765;
